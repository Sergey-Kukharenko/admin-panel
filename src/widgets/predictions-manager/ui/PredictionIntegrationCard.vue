...
<template>
  <article
    class="w-[382px] max-w-[382px] h-32 min-h-[128px] shrink-0 px-2 pb-2 bg-[var(--bg-surface-neutral)] rounded-[var(--radius-md)] flex flex-col justify-start items-start overflow-hidden transition-all duration-200"
  >
