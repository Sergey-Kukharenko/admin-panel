  ...
  >
    <div class="flex flex-col gap-5 px-5 pt-5">
      <div class="flex items-center gap-1.5">
        ...
        <div v-if="status === 'not_configured'" class="ml-auto flex shrink-0 items-center gap-1">
        ...
        <div v-else-if="status === 'pending'" class="ml-auto">
          <AppTooltip :icon="false" :text="PENDING_TOOLTIP_TEXT">
        ...
        <div v-else class="ml-auto flex shrink-0 items-center gap-1">
