  ...
  datasets: {
    ...
    upload: {
      ...
      confirmDialog: {
        ...
        description:
          'Действие нельзя отменить. Файлы будут отправлены для обучения ML-моделей. После отправки данные нельзя будет отозвать. Процесс обучения займёт от 5 до 14 дней.',
    ...
    errorDialog: {
      ...
      file: 'Файл',
      dataType: 'Тип данных',
      checkedRows: 'Проверено строк',
      errorColumns: 'Колонок с ошибками',
