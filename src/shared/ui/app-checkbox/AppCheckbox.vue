...
<template>
  ...
  >
    <CheckboxRoot
      ...
      :checked="modelValue"
      :disabled="disabled"
      class="relative flex size-4 shrink-0 items-center justify-center rounded-(--radius-md) border border-(--border-default) bg-(--muted) outline-none transition-colors duration-150 ease-in-out hover:bg-(--muted-hover) active:border-2 active:border-(--border-accent) focus-visible:ring-4 focus-visible:ring-(--border-accent) focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-surface-primary) disabled:pointer-events-none disabled:opacity-50 data-[state=checked]:border-transparent data-[state=checked]:bg-(--bg-accent) data-[state=checked]:shadow-(--shadow-field) data-[state=checked]:hover:bg-(--bg-accent-hover)"
